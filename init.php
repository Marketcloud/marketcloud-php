...
include(dirname(__FILE__) . '/libs/Addresses.php');
...
include(dirname(__FILE__) . '/libs/Collections.php');
include(dirname(__FILE__) . '/libs/Contents.php');
include(dirname(__FILE__) . '/libs/Coupons.php');
include(dirname(__FILE__) . '/libs/Files.php');
...
include(dirname(__FILE__) . '/libs/Stores.php');
include(dirname(__FILE__) . '/libs/StripePayments.php');
include(dirname(__FILE__) . '/libs/BraintreePayments.php');
include(dirname(__FILE__) . '/libs/Users.php');
include(dirname(__FILE__) . '/libs/Variables.php');
